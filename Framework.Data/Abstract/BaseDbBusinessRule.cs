...
namespace Framework.Data.Abstract
{
		...
		where TRepository : IDbRepository<TEntity>
	{
		...
		/// <param name="repository">The protected repository based on IDbRepository.</param>
		protected BaseDbBusinessRule (TRepository repository)
			: this(repository, null) { }

		/// <summary>Specialised constructor for use only by derived classes.</summary>
		/// <param name="repository">The protected repository based on IDbRepository.</param>
		/// <param name="nextRule">The next IDbBusinessRule of type <typeparamref name="TEntity"/> to process.</param>
